import { GraphQLConfig } from './index';

const html = (baseEndpoint: GraphQLConfig['baseEndpoint']) => `
<!DOCTYPE html>
<html>
  <head>
    <meta charset=utf-8 />
...
export const handlePlaygroundRequest = (request: Request, { baseEndpoint }: GraphQLConfig) =>
